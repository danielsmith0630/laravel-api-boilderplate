...
return [
     ...
     */
    'title' => 'The Larabel Boilderplate API',
    ...
    'routes' => [
        [
             ...
             */
            'include' => [
                '/oauth/token' // 'users.index', 'healthcheck*'
            ],
             ...
             */
            'exclude' => [
                'v1/auth/*/redirect', 'v1/auth/*/callback' // '/health', 'admin.*'
            ],
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your access token by calling <code>POST /oauth/token</code> endpoint.',
    ],
